...
public class ApproveBudgetServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) 
        ...
        String originalFilePath = projectRoot + "/data/approved_scso.csv";
        String approvedFilePath = projectRoot + "/data/approved_fm.csv";
